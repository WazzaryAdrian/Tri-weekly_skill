...
### A-2 ABS/AJG 4*/4 中相关刊（FT50 之外的高分核心，按上面六组）
组织行为/组织心理：Personnel Psychology；Journal of Organizational Behavior；Journal of Vocational Behavior；The Leadership Quarterly；Organizational Research Methods；Journal of Occupational and Organizational Psychology。
人力资源/雇佣关系：Human Resource Management Journal (UK)；Work, Employment and Society；ILR Review；British Journal of Industrial Relations；International Journal of Human Resource Management；Asia Pacific Journal of Human Resources（旧名 Asia Pacific Human Resource Management，Wiley/AHRI，ABDC A、Q1）。
综合管理/伦理：British Journal of Management；Business Ethics Quarterly。
战略：Strategic Entrepreneurship Journal；Global Strategy Journal；Long Range Planning。
组织研究：Organization。
（以上为六组中 4*/4 的代表性刊；评级口径以 AJG 2024 为准，完整 3 分长尾见"选取规则"，可用 fetch_candidates 的刊名表逐步补全。）
